...
extern void  ggml_vec_dot_i2_i8_s(int n, float * s, size_t bs,
                                    const void * vx, size_t bx,
                                    const void * vy, size_t by,
                                    int nrc);

extern size_t quantize_i2_s(const float * src, void * dst,
 ...
 */
static void avx2_vec_dot_i2_i8(
 ...
 */
static size_t avx2_quantize_i2(
    ...
    int nr, int nc)
{
    ...
    for (int row = 0; row < nr; row++) {
        ggml_vec_dot_i2_i8_s(
            n, s + row, 0,
            x + row * row_bytes_packed, row_bytes_packed,
            vy, 0, 1);
    }
}
